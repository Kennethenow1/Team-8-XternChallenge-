...
Table 06-1 Dispatch per Fuel Type for Study and Higher Queued Generators (without a GIA)
...
study deposit in the amount of $150,00060,000. The request can be submitted at any time with
the Commercial Operation Date at least one year after the submission date of the Surplus
