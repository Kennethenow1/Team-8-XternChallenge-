...
PHRASES: list[tuple[str, dict[str, list[str]]]] = [
    ...
    (r"\bcod\b|\bcommercial operation\b|\bin-service date\b|\bservice date\b", {"topic": ["commercial_operation"], "risk_code": ["cod_already_slipped"]}),
    ...
    (r"\bD2\b|\bstudy funding\b", {"milestone": ["D2"], "topic": ["deposit_refund"], "risk_code": ["cost_pressure"]}),
    (r"\bdeposit\b|\bletter of credit\b|\brefund", {"topic": ["deposit_refund"]}),
    ...
    (r"\bpost-?gia\b|\bsuspension\b", {"gi_phase": ["post_gia"]}),
]
